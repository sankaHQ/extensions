...
def _release_snapshot(tmp_path: Path) -> tuple[Path, Path]:
    ...
    packages = {
        ...
        "sanka-code-migration": (
            "0.1.0a2",
            "sanka_code_migration-0.1.0a2-py3-none-any.whl",
            "",
        ),
        ...
        "sanka-extension-drf-to-fastapi": (
            "0.1.0a15",
            "sanka_extension_drf_to_fastapi-0.1.0a15-py3-none-any.whl",
            "[console_scripts]\n"
...
def test_converter_dependency_closures_resolve_without_an_index(
    ...
    assert "sanka-code-migration==0.1.0a2" in result.stderr
...
def test_release_validator_rejects_invalid_release_boundaries(
    ...
    if case == "connector_entry_point":
        ...
        fastapi = release / "sanka_extension_drf_to_fastapi-0.1.0a15-py3-none-any.whl"
        _metadata_wheel(
            release,
