...
"""PostgreSQL data extension: source + destination roles for Sanka migrations.
...
__all__ = ["CONNECTOR", "DATA_EXTENSION", "PostgresDestination", "PostgresSource"]

DATA_EXTENSION = DataExtensionRegistration(
    name="postgres",
