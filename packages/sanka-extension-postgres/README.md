...
PostgreSQL extension for Sanka, registering both roles under the `postgres`
...
Apache-2.0; depends only on the `sanka-extension-sdk` data interface and `psycopg[binary]`.
