...
:class:`sanka_extensions.data.SupportsSnapshotBounds` freezes a run's scope at
...
if TYPE_CHECKING:
    from sanka_extensions.data import DataReader, SupportsRecordCounts, SupportsSnapshotBounds

    _protocol_source: DataReader = PostgresSource()
