...
OUTPUT = "rust"
PLAN_SCHEMA = "sanka.typescript-to-rust.plan/v1"
LIMITATION = "Experimental endpoint contract only; not a complete backend migration."
    ...
    try:
        ...
        if request.command == "scan":
            ...
            if request.command == "apply":
                ...
                staging = Path(tempfile.mkdtemp(prefix=".rust-", dir=artifacts))
                try:
