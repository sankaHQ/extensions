...
from sanka_extension_sqlite import EXTENSION, SqliteDestination, _identifier
...
async def test_inventory_readback_and_target_suggestion(tmp_path: Path) -> None:
    ...
    assert EXTENSION.name == "sqlite"
    assert EXTENSION.destination is not None and EXTENSION.source is not None
